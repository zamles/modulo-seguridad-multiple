...
<head runat="server">
    ...
    <title>Modulo Seguridad | Log in</title>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<%=ResolveClientUrl("theme/bower_components/font-awesome/css/font-awesome.min.css")%>" />

    <!-- Ionicons -->
    <link rel="stylesheet" href="<%=ResolveClientUrl("theme/bower_components/Ionicons/css/ionicons.min.css")%>" />

    <!-- Theme style -->
    <link rel="stylesheet" href="<%=ResolveClientUrl("theme/dist/css/AdminLTE.css")%>" />

    <!-- iCheck -->
    <%--<link rel="stylesheet" href="../../plugins/iCheck/square/blue.css">--%>
    <!-- iCheck for checkboxes and radio inputs -->
    <link rel="stylesheet" href="<%=ResolveClientUrl("theme/plugins/iCheck/all.css")%>" />
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <h1>Modulo Seguridad</h1>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Inicie sesion con credenciales validas</p>
            ...
            <label>
              <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="checkbox" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Remember Me
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <asp:Button ID="btnLogin" runat="server" Text="Acceder" CssClass="btn btn-primary btn-block btn-flat" OnClick="btnLogin_Click" />
                    </div>
                    <!-- /.col -->
                </div>
            </form>
