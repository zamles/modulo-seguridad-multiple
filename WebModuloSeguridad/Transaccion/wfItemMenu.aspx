<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="wfItemMenu.aspx.cs" Inherits="Transaccion_wfItemMenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" Runat="Server">
     ...
     <section class="content-header">
      <h1>
       Items Menus
        <small>Item Menu del Sistema </small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
             ...
             <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Agregar ItemMenu</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label ">Enlace </label>
                            <asp:TextBox ID="txtEnlace" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>                        
                        <div class="form-group">
                            <label ">Peso </label>
                        ...
                        <div class="form-group">
                            <asp:GridView ID="gvLista" CssClass="dynamic-table table table-striped table-bordered table-hover col-xs-12 col-sm-12 col-lg-12" Width="100%" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Nombre" HeaderText="Item Menu" />                                                                        
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div style="display: flex;">
                                                <%--<asp:DropDownList ID="ddlEventos" runat="server" Width="150px"></asp:DropDownList>--%>
                                                <asp:LinkButton ID="lnkEvento" runat="server" Text="<i class='fa fa-arrow-circle-right'></i> Actualizar" CssClass="btn btn-success btn-xs botones" ToolTip="Realizar Accion" CommandArgument='<%#Bind("IdItemMenu") %>' CommandName="Actualizar" OnClick="lnkEvento_Click" Enabled="false" />
                                                <asp:LinkButton ID="lnkPermiso" runat="server" Text="<i class='fa fa-arrow-circle-right'></i> Agregar Permiso" CssClass="btn btn-warning btn-xs botones" ToolTip="Realizar Accion" CommandArgument='<%#Bind("IdItemMenu") %>' CommandName="Mover" OnClick="lnkPermiso_Click" Enabled="false"/>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
